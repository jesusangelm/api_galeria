...
// generic helper for sending JSON-formatted error messages
// we are using any type at message parameter for more flexibility
...
func (app *application) inactiveAccountResponse(w http.ResponseWriter, r *http.Request) {
	message := "you user account must be activated to acces this resource"
	app.errorResponse(w, r, http.StatusUnauthorized, message)
}
